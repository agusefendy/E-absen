      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href=""><i class="nc-icon nc-single-02"></i> Data User</a>
          </div>
        ...
        <div class="col-md-12">
          <div class="card card-plain">
            <div class="card-header">
              <h4><i class="nc-icon nc-single-02"></i> Data User</h4>
          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <div id="content"><?php include "contentdatauser.php"; ?></div>
            </div>
          </div>
        </div>
      </div>
...
//       message: "Welcome to <b>Paper Dashboard</b> - a beautiful bootstrap dashboard for every web developer. Hello Word"
