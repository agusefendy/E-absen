            ...
            <div class="card card-plain">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  ...
                  <?php
                    $q = mysqli_query($koneksi, "SELECT * from kelas natural join siswa natural join absen where kelas.idkelas='$idkelas' and month(tglabsen)='$bln' and year(tglabsen)='$thn'");
