...
if(isset($_POST['keyword'])){
  ...
  $q = mysqli_query($koneksi, "SELECT * from siswa where idkelas='$idkelas' AND namasiswa LIKE '%$keyword%' ORDER BY namasiswa LIMIT $limit_start, $limit");
  ...
  $q = mysqli_query($koneksi, "SELECT * from siswa where idkelas='$idkelas' ORDER BY namasiswa LIMIT $limit_start, $limit");
  $cek = mysqli_num_rows($q);
  //paging setting
