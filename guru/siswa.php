...
<body class="">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-plain">
              ...
              ?>
                <h4 class="card-title"> <i class="nc-icon nc-single-copy-04"></i> Data <?php echo ucwords("$asset[tipeabsen]"); ?></h4>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      $("#content").load("contentsiswa.php?idkelas=<?php echo $idkelass; ?>");
    })
     ...
     $(document).ready(function(){
      ...
      function Pagination(page_number){
        $.ajax({
          url: 'contentsiswa.php?idkelas=<?php echo $idkelass; ?>',
          type: 'POST',
