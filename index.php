  ...
  <canvas id="bigDashboardChart"></canvas>
          ...
          <div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Login Profile</h5>
              </div>
              <div class="card-body">
                <form method="POST">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control" placeholder="Username" maxlength="50" autofocus required/>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      <button type="submit" name="login" class="btn btn-primary btn-round" value="Login">Login</button>
                    </div>
                  </div>
                </form>
              </div>
      ...
      <?php
        if(isset($_POST['login'])){
          ...
          $sql = mysqli_query($koneksi, "SELECT * from guru where username='$username' and password='$password'");
          $data = mysqli_fetch_array($sql);
          ...
          if($cek > 0){
            ...
            if($level == 'admin'){
              ...
              echo "<script> window.location.href='min/' </script>";
            }else if($level == 'guru'){
              $_SESSION['idguru'] = $data['idguru'];
              echo "<script> window.location.href='guru/' </script>";
            }else{ ?>
              <script>
              swal({
                  position: 'center',
